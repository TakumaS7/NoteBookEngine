/*===============================================================*/
//
//	createCharaChange.cpp(作成キャラ状態変更管理)
// 
// 
// ---------------------------------- 2026/02/08 製作者：佐藤琢磨
//
...
void CreateCharaChange::Set(const std::wstring& texture, XMFLOAT2& pos, float& rotation, XMFLOAT2& scale, const std::wstring& charaName)
{
	/* テクスチャパスとキャラの名前を取得 */
...
std::wstring CreateCharaChange::GetTexture() const
{
	return m_textureName;
}

Transform CreateCharaChange::GetCharaTransform() const
{
	return m_charaTransform;
}

std::wstring CreateCharaChange::GetCharaName() const
{
	return m_charaName;
}

void CreateCharaChange::Init()
{
	...
	AddComponent<TextComponent>()->Set(L"キャラクター状態変更", this->GetComponent<Transform>(), false, D2D1::ColorF::White, { -10.0f, -36.0f, 0.0f });
