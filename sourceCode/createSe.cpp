...
void CreateSe::Init()
{
	...
	AddComponent<TextComponent>()->Set(L"SEÇó¨Ç∑", this->GetComponent<Transform>(), false, D2D1::ColorF::White, { -10.0f, -36.0f, 0.0f });
...
std::wstring CreateSe::GetSe() const
{
	return m_seName;
}
