/*===============================================================*/
//
//	createSpeakTextHidden.cpp(作成テキストフレーム非表示管理)
// 
// 
// ---------------------------------- 2026/03/01 製作者：佐藤琢磨
//
...
void CreateSpeakTextHidden::Init()
{
	...
	AddComponent<TextComponent>()->Set(L"テキストフレーム非表示", this->GetComponent<Transform>(), false, D2D1::ColorF::White, { -10.0f, -36.0f, 0.0f });
