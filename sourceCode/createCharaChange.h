/*===============================================================*/
//
//	createCharaChange.h(作成キャラ状態変更管理)
// 
// 
// ---------------------------------- 2026/02/08 製作者：佐藤琢磨
//
...
#ifndef _CREATE_CHARA_CHANGE_H
#define _CREATE_CHARA_CHANGE_H
...
class CreateCharaChange : public GameObject
{
private:
	std::wstring m_textureName = L"キャラ画像名";	// パス全部
	std::wstring m_frameName = L"キャラ画像名";		// ファイル名と座標、回転、大きさと、キャラの名前
