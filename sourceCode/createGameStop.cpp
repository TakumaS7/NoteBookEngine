/*===============================================================*/
//
//	createGameStop.cpp(çÏê¨ÉQÅ[ÉÄí‚é~ä«óù)
// 
// 
...
void CreateGameStop::Init()
{
	...
	AddComponent<TextComponent>()->Set(L"ÉQÅ[ÉÄí‚é~", this->GetComponent<Transform>(), false, D2D1::ColorF::White, { -10.0f, -36.0f, 0.0f });
